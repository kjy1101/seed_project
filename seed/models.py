...
class Seed(models.Model):
    ...
    user = models.ForeignKey("main.User", related_name="user", on_delete=models.CASCADE, null=True, blank=True, help_text="생성한 사람")
    ...
    microscope = models.BooleanField(default=True, null=True, blank=True, help_text="현미경")
    grain = models.CharField(max_length=2, choices=GRAIN_CHOICES, null=True, blank=True, help_text="단립/복립")
